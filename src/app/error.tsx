...
const ErrorPage = ({ error, reset }: IProps) => (
  <main
    className="bg-gray-900 grid min-h-screen place-items-center px-6 py-24 sm:py-32 lg:px-8"
    aria-live="assertive"
  >
    <div className="text-center">
      ...
      <p className="mt-6 text-xl leading-7 text-zinc-100">Please try again.</p>
